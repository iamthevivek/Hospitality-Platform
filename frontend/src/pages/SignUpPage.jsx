    ...
    <div className="min-h-[calc(100vh-80px)] bg-[#f3f4f6] flex items-center justify-center p-4 sm:p-6 lg:p-10">
      <div className="bg-white rounded-[32px] shadow-2xl shadow-slate-200/90 p-4 sm:p-6 max-w-4xl w-full grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch border border-slate-100">
        ...
        <div className="flex flex-col justify-center px-2 sm:px-6 py-4">
          ...
          {fromLocation && (
            <div className="mb-3 p-3 bg-teal-50 border border-teal-200 rounded-xl text-teal-800 text-xs font-medium">
              Create an account to complete your room reservation instantly.
            </div>
          )}

          {error && (
            <div className="mb-3 p-3 bg-red-50 border border-red-200 rounded-xl flex items-center space-x-2 text-red-700 text-xs">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div className="flex items-center text-xs pt-1">
              <label className="flex items-center space-x-2 text-slate-600 cursor-pointer">
                ...
                <span>
                  I agree to the{' '}
                  <span className="text-[#0d7e8a] font-semibold hover:underline">
                    Terms & Conditions
                  </span>
                </span>
              </label>
